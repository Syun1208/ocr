...
# main work directory
WORK_DIR = '/'.join(FILE.split("/")[:-1])

class FilePaths:
    """Filenames and paths to data."""
    fn_char_list = os.path.join(WORK_DIR, 'model/charList.txt')
...
# def recognizer(image, decoder='wordbeamsearch'):
#     args = parse_args()
...
#     recognized, probability = infer(model, image)
