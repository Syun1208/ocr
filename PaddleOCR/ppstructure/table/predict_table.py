...
def table_recognizer_ppocr(image):
    args = parse_args()
    args.det_model_dir = os.path.join(ROOT, 'pretrained_table_en/en_PP-OCRv3_det_infer/')
    args.rec_model_dir = os.path.join(ROOT, 'pretrained_table_en/en_PP-OCRv3_rec_infer/')
    args.table_model_dir = os.path.join(ROOT, 'pretrained_table_en/en_ppstructure_mobile_v2.0_SLANet_infer/')
    args.rec_char_dict_path = os.path.join(ROOT, 'pretrained_table_en/en_dict.txt')
    args.table_char_dict_path = os.path.join(ROOT, 'pretrained_table_en/table_structure_dict.txt')
