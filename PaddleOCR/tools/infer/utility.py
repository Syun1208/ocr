...
def init_args():
    ...
    parser.add_argument("--det_model_dir", type=str, default='/home/hoangtv/Desktop/Long/customer/PaddleOCR/tools/infer/pretrained_table_en/en_ppocr_mobile_v2.0_table_det_infer/')
    ...
    parser.add_argument("--rec_model_dir", type=str, default='./pretrained_table_en/en_ppocr_mobile_v2.0_table_rec_infer/')
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default="./pretrained_table_en/en_dict.txt")
